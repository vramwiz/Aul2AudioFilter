...
- `無音_極小ノイズ_ループ推奨.wav`: -90dB 相当の極小ノイズ入り無音。エコーやリバーブの尾を残すため、音声素材の後ろにループ配置する用途。
...
- 16bit PCM
- stereo
- `impulse_tail_3s.wav`、`level_steps_3s.wav`、`echo_check_3s.wav`、`無音_極小ノイズ_ループ推奨.wav` 以外は 1 秒
